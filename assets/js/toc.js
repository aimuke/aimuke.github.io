...
(function($){
  ...
  $.fn.toc = function(options) {
    var defaults = {
      ...
      minimumHeaders: 3,
      listNumber: 'y', // auto create toc number [y|n]
    ...
    function createLabel(header, tocNumber) {
      var html = "<a class=\"toc-link\" href='#" + fixedEncodeURIComponent(header.id) + "'>";
      if (settings.listNumber === 'y') {
        html += "<span class='toc-number'>" + tocNumber + "</span>";
      }
    ...
    .each(function(_, header) {
      ...
      if (this_level === level) {// same level as before; same indenting
        ...
        html += createLabel(header, stack.toc_number());
